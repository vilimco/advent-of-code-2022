...
class Monkey:
    ...
    def run_round(self):
        for item in self.items:
            ...
            if bored_value % self.div_test == 0:
                self.toss_to_true.catch_item(bored_value)
            else:
                self.toss_to_false.catch_item(bored_value)
...
for i in range(0, number_of_rounds):
    ...
    print("After round", i + 1, ", the monkeys are holding items with these worry levels:")
    for idx, monkey in enumerate(monkeys):
        print("Monkey", idx, monkey.items)
